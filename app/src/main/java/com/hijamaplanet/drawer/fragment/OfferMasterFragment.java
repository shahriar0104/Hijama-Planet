...
import com.hijamaplanet.drawer.adapter.OfferMasterAdapter;
...
public class OfferMasterFragment extends Fragment implements ItemClickListener {

    private static final String TAG = OfferMasterFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.nav_offer_fragment, container, false);
        ...
        OfferMasterAdapter masterAdapter = new OfferMasterAdapter(getActivity(), this,offerList);
        lv.setAdapter(masterAdapter);
